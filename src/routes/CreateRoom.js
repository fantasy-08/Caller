...
const CreateRoom = (props) => {
	...
	return (
		<>
			<BhaluBar handleLogout={props.handleLogout} />
			<br />
			<Container>
				<Grid
					container
						...
						>
								...
								>
									<div style={{ textAlign: "center" }}>
										<a href="https://servercaller.herokuapp.com/Caller/">
											<img
												src="https://fontmeme.com/permalink/210105/969ea6d61fc59fdf9fa681c5f4f56a23.png"
												alt="hindi"
												border="0"
											/>
										</a>
							...
							<Grid item sm={12}>
								<Typography
									...
									style={{ color: "grey" }}
								>
									We re-engineered the service we built for
									secure business meetings, संभव, to make it
